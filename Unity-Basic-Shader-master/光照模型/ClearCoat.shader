Shader "Unlit/ClearCoat"
{
    
    Properties
    {
        [KeywordEnum(Value,Tex)] Mode("useValue or Tex ", Float) = 0
        ...
        [Space]
        [Space]
        _ClearCoat("_ClearCoat",Range(0,1)) =1
        _RoughnessClearCoat("_RoughnessClearCoat",Range(0,1)) =0.5
...
//================== Indirect Light  ============================================== //
                ...
                return (DirectLight + IndirectLight).xyzz;
